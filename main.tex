...
%
  ...
  %some convenient environments for for overlays
...
\title[Short Title]{The full title of your presentation }

\author{
\centering
    Your Name \\ Your affiliation \\ \href{mailto://you@uga.edu}{\texttt{you@uga.edu}}
}


\date[]{
    \centering 
        \color{red} {\vskip .25in}
        Date of talk \\ Name of venue \\ location of venue
}
\maketitle
...
\begin{frame}
	...
	\centering
\only<1>{        \includegraphics[height=0.75\textheight]{./includes/mgmt_dist1.pdf}    }
\only<2>{        \includegraphics[height=0.75\textheight]{./includes/mgmt_dist2.pdf}    }
\end{frame}
%**********************************************
...
\begin{slide}
  ...
  \begin{center}
      \scalebox{.45}{
          \input{./includes/e1_tab_prodfcn_2008_old.tex}    
      }
\end{center}
\scalebox{.5}{
